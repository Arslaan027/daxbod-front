...
const Inventory = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-[100vh]  p-4 sm:ml-64 flex flex-col gap-5 mt-14 dark:bg-gray-800">
      ...
      <div className="flex flex-col sm:flex-row gap-5">
        <div className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md mt-6 w-full sm:w-1/2">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-200">
            Add New Item
          </h2>
        ...
        <div className="bg-gray-300 dark:bg-gray-900 p-6 rounded-lg shadow-md mt-6 w-full sm:w-1/2 flex flex-col justify-center items-center text-center">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-200">
            Cost Analyzer
          </h2>
